                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="contact-info">
                                ...
                                <h3><i class="fa fa-map-marker"></i>R. da Mangueira, 33 - Nazaré, Salvador - BA</h3>
                                <h3><i class="fa fa-envelope"></i>compraCerta@hotmail.com</h3>
                                <h3><i class="fa fa-phone"></i>(71) 3021-2800</h3>
                                <div class="social">
                            ...
                            <div class="contact-form">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Sujeito" />
                                    </div>
                                    <div class="form-group">
